...
@pytest.mark.parametrize(
    "provider_name", ["perplexity", "baidu", "tavily", "exa", "serper", "jina"]
)
...
def test_web_search_consolidates_results_for_serp_providers(
    mock_answer_consolidator, mock_get_provider
):
    """
    ...
    mock_answer_consolidator.assert_called_once_with(
        consolidation_type="llm", custom_template=None, llm_config=None
    )
