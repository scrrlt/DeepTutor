...
from src.agents.solve.memory.investigate_memory import InvestigateMemory, KnowledgeItem, Reflections
...
def test_investigate_memory_initialization(investigate_memory: InvestigateMemory):
    """
...
def test_add_knowledge(investigate_memory: InvestigateMemory):
    ...
    """
    item = KnowledgeItem(cite_id="cite1", tool_type="test_tool", query="test_query", raw_result="test_result")
...
def test_load_backward_compatibility(tmp_path):
    ...
    v1_data = {
        "version": "1.0",
        "knowledge_chain": [{"knowledge_id": "kid1", "source_type": "st1", "query_text": "q1", "answer_raw": "a1"}],
