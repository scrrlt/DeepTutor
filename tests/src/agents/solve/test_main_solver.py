...
async def test_main_solver_custom_config_initialization():
    ...
    with patch(
        ...
        mock_load_config.return_value = {
            ...
            "logging": {},
            "tools": {},
            "system": {"language": "en", "output_base_dir": "/tmp/test_output"},
        }
...
async def test_main_solver_dual_loop_pipeline():
    ...
    with patch(
        ...
        ) as mock_investigate_memory, patch(
            "src.agents.solve.main_solver.SolveMemory"
        ) as mock_solve_memory, patch(
            "src.agents.solve.main_solver.CitationMemory"
        ):
