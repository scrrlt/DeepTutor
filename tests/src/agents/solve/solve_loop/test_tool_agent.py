...
from src.agents.solve.memory import SolveMemory, CitationMemory, SolveChainStep, ToolCallRecord
...
async def test_tool_agent_process_workflow(tool_agent: ToolAgent):
    ...
    step.tool_calls.append(ToolCallRecord(tool_type="rag_hybrid", query="test_query", cite_id="cite1"))
...
async def test_execute_single_call(mock_run_code, mock_web_search, mock_rag_search, tool_agent: ToolAgent):
    """
