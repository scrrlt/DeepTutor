...
def research_pipeline() -> ResearchPipeline:
    ...
    with patch("src.agents.research.research_pipeline.get_logger"):
        config = {
            "system": {"output_base_dir": "/tmp/test_cache", "reports_dir": "/tmp/test_reports"},
            "planning": {"rephrase": {"enabled": True}, "decompose": {"mode": "manual", "initial_subtopics": 2}},
